...
- [x] **FEATURE (2026-04-17 13:00):** Smart Scheduling Widget — pełnej szerokości widget AI insights na dashboardzie z 6 kartami: artykuły do optymalizacji, szkice gotowe do publikacji, top dla social media (z wp_views), luki portfolio (brak pillar page), AI-sugerowane trending tematy (gemini-2.0-flash) z przyciskiem "Użyj" → przenosi do generatora z wypełnionymi polami, najlepszy dzień publikacji (z wp_views lub fallback wtorek). Cache 6h per user w `insights_cache`

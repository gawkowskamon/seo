...
@api_router.post("/surfer/analyze-serp")
...
@api_router.post("/surfer/analyze-serp/async")
...
WAŻNE: Wygeneruj 20-30 NLP terms z importance wysoka/średnia/niska, 5-8 konkurentów, 8-12 sugestii nagłówków, 5-8 pytań."""
    ...
    _surfer_executor = ThreadPoolExecutor(max_workers=2)
    _surfer_executor.submit(_run, job_id, keyword)
    return {"job_id": job_id, "status": "running"}


@api_router.get("/surfer/analyze-serp/status/{job_id}")
...
@api_router.post("/surfer/keyword-research")
...
@api_router.post("/surfer/content-planner")
...
@api_router.post("/surfer/audit-url")
